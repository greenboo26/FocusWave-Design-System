...
长期洞察页由墨池（赏鱼、喂食、每日完成专注沉淀为莲花）与下方专注档案组成：档案提供日/周/月视图、分段时间线、练习记录、时段分布与最佳专注窗口。首页随机轮换海面、线香、山形三种持续运动效果。今日页轮换引言已接入按模式取用的内容管线（D-024）：极简不显示引言，原创短句模式按意象主题×状态同题取用 64 条人工原创与 128 条离线新创，世界文学显示 16 篇公版中译（原文悬浮可查），中文古典合并 16 篇古典库与 20 条审核精选；模式在设置中切换即时生效。
