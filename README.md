...
长期洞察页由墨池（赏鱼、喂食、每日完成专注沉淀为莲花）与下方专注档案组成：档案提供日/周/月视图、分段时间线、练习记录、时段分布与最佳专注窗口。首页随机轮换海面、线香、山形三种持续运动效果。内容库当前在库 20 条审核短句（中文古典与原创），AI 草稿扩写为本地预览；世界文学与中文古典的独立内容文件已备好，等待接入按模式取用的管线。
